...
int main()
{
    ...
    float endAngle = 2.0f * 3.14159265359f - 0.5f;

    vertices.push_back(radius * cos(startAngle));
    vertices.push_back(radius * sin(startAngle));

    for (int i = 0; i <= segments; i++)
    {
        float angle =
            startAngle +
            (endAngle - startAngle) * i / segments;
    ...
    vertices.push_back(radius * cos(endAngle));
    vertices.push_back(radius * sin(endAngle));
